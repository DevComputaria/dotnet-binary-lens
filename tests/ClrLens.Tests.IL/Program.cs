...
Console.WriteLine($"T06 IR harness: PASS ({model.Identity.Name}, {model.TypeCount} types, {model.MethodCount} methods, IR nodes={irNodes}, allocations={allocationNodes}, values={distinctValues})");
